...
public class Start {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Demarrage du distributeur de noeud de calculs");
            System.out.println("Services enregistrés sous le nom : raytracer");
            System.out.println("Rmiregistry en écoute sur le port " + args[0]);
